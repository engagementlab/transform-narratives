...
export const componentBlocks = {
  image: component({
   ...
   button: component({
      ...
      //  const data = (props.image.value as unknown as HydratedRelationshipData).data;
       return (      
         <div style={{ backgroundColor: 'rgb(247 247 247)', display: 'inline-block', borderRadius: '38px', padding: '1rem'}}
          ...
          <div style={{ fontStyle: 'italic', color: '#4A5568' }}><NotEditable><svg viewBox="70.001 0.006 10 10" width="10" height="10">
