            ...
            <Link href="/" passHref>
                <svg viewBox="0 0.081 81.459 50" width="81.459" height="50">
                    <g transform="matrix(0.159112, 0, 0, 0.159112, 0, 0.068195)">
                        <path d="M149,61.7V17.8H0v43.9h32.2c3.9,0,11.1-0.8,14.4,0.2v132.7H102V74.4c0-3.5-0.7-9.8,0.2-12.7H149z"></path>
                        ...
                        <path d="M509.3,171c1.5-2.9,3.2-6.1,2.5-9.6c-1.1-6-3.6-10.3-7.4-12.5c-3.6-2.1-8-2.2-13.2-0.3l-1.2,0.4l-0.4,0.1
                            ...
                            c0.5-0.2,1-0.3,1.5-0.3c0.9-0.1,1.9-0.3,2.8-0.7c2.7,0,4.5,0.6,5.5,1.6s1.6,2.9,1.6,5.5C503.1,163.7,502.8,165.6,502.2,167.5z"></path>
                    </g>
                </svg>
            </Link>
          </div>
