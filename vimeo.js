...
const getData = async (apiPath) => {
  ...
  const response = await axios.get(`https://api.vimeo.com${apiPath || '/channels/1773240/videos?per_page=100'}`, {
    headers: {
  ...
  if (fs.existsSync('videoData.js'))
    fs.unlinkSync('videoData.js');
